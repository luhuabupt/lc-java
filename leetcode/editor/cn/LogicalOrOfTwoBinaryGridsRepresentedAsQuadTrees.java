...
public class LogicalOrOfTwoBinaryGridsRepresentedAsQuadTrees {
    public static void main(String[] args) {
        Solution s = new LogicalOrOfTwoBinaryGridsRepresentedAsQuadTrees().new Solution();
        System.out.println("");
    }
    ...
    class Solution {
        public Node intersect(Node a, Node b) {
            ...
            ans.topLeft = intersect(a.topLeft, b.topLeft);
            ans.topRight = intersect(a.topRight, b.topRight);
            ans.bottomLeft = intersect(a.bottomLeft, b.bottomLeft);
            ans.bottomRight = intersect(a.bottomRight, b.bottomRight);

            return maintain(ans);
        }

        public Node maintain(Node a) {
            if (a.topLeft.isLeaf && a.topRight.isLeaf && a.bottomLeft.isLeaf && a.bottomRight.isLeaf) {
                if (a.topLeft.val == a.topRight.val && a.topLeft.val == a.bottomLeft.val && a.topLeft.val == a.bottomRight.val) {
                    a.isLeaf = true;
                    a.val = a.topLeft.val;
                    a.topLeft = null;
                    a.topRight = null;
